...
setup(
    ...
    entry_points={
        "console_scripts": [
            "docking_pose_estimator = usv_docking.docking_pose_estimator:main",
            "docking_fsm = usv_docking.docking_fsm:main",
            "docking_motion_controller = usv_docking.docking_motion_controller:main",
            "docking_safety = usv_docking.docking_safety:main",
        ],
    },
)
